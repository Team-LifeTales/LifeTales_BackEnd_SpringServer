...
public class AuthenticationConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws  Exception{
        return httpSecurity
                ...
                .and()
                .authorizeRequests()
                .antMatchers( "/api/v1/users/basic/login" , "/api/v1/users/basic/signUp/**" , "/api/v1/family/createFamily/detail" , "/api/v1/users/admin/register", "/api/v1/users/admin/login").permitAll()
