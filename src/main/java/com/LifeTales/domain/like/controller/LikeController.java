...
public class LikeController {
    ...
    public LikeController(ObjectMapper objectMapper, CommentService commentService, LikeRepository likeRepository, UserRepository userRepository, LikeService likeService, LikeChecker likeChecker) {
    ...
    public ResponseEntity checkLikeForFeed(@RequestParam("feedSeq") Long feedSeq,
                                                       @RequestParam("id") String id,
                                                       @RequestParam("checkType") String checkType) throws IOException {
        /**
         * do
         * 하트를 눌렀을 때 동작하는 코드
        ...
        boolean checkFeedSeqExists = likeChecker.doesFeedSeqExist(feedSeq);
        boolean checkUserIdExists = likeChecker.doesUserIdExist(id);
        ...
        if(checkFeedSeqExists && checkUserIdExists){
            ...
            boolean likecheck = likeChecker.doesLikeSeqExist(user,feed);
            if(likecheck){
